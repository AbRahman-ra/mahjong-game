 ...
 */
export const TILE_COPIES: Readonly<Record<NumberTileGroup | NonNumberTileGroup, number>> = {
    [NumberTileGroup.NUMBER]: 4,
    [NonNumberTileGroup.DRAGON]: 4,
    [NonNumberTileGroup.WIND]: 4,
}
